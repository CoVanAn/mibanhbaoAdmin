...
export const productKeys = {
  ...
  variants: (productId) => [...productKeys.all, productId, "variants"],
};
 ...
 */
export function useProductVariantsQuery(productId) {
  return useQuery({
...
export function useCreateVariantMutation() {
  ...
  return useMutation({
    mutationFn: ({ productId, data }) => createProductVariant(productId, data),
    onSuccess: (_, variables) => {
      queryClient.invalidateQueries({
...
export function useAddMediaMutation() {
  ...
  return useMutation({
    mutationFn: ({ productId, files }) => addProductMedia(productId, files),
    onSuccess: (_, variables) => {
      queryClient.invalidateQueries({
        queryKey: productKeys.detail(variables.productId),
      });
